...
namespace Michsky.UI.ModernUIPack
{
    public class WindowManager : MonoBehaviour
    {
        ...
        {   
            ...
            Debug.Log("starting... current windiw index");
            Debug.Log(currentWindowIndex);
        }
        ...
        public void OpenPanel(string newPanel)
        {
            ...
            {
                Debug.Log("new windiw index " + newWindowIndex.ToString());
                Debug.Log("current windiw index " +currentWindowIndex.ToString());
                currentWindow = windows[currentWindowIndex].windowObject;
                currentButton = windows[currentWindowIndex].buttonObject;
