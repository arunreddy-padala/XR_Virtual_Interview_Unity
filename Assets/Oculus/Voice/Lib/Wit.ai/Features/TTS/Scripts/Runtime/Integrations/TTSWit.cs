        ...
        public void RequestStreamFromWeb(TTSClipData clipData)
        {
            ...
            request.RequestStream(clipData.textToSpeak, clipData.queryParameters,
                (clip, error) =>
                {
                    ...
                    clipData.clip = clip;
                    AvatarModel.GetComponent<AudioSource>().clip = clip;
                    // AvatarModel.GetComponent<AudioSource>().gameObject.SetActive(false);
                    // AvatarModel.GetComponent<AudioSource>().gameObject.SetActive(true);
